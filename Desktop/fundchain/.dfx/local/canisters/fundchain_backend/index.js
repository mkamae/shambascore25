...
import { idlFactory } from './fundchain_backend.did.js';
export { idlFactory } from './fundchain_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FUNDCHAIN_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./fundchain_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the fundchain_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./fundchain_backend.did.js")._SERVICE>}
 */
export const fundchain_backend = createActor(canisterId);
